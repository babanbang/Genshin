...
export const metaData = {
	...
	passive: [
		...
		},
		{
			name: "光辉的季节",
			desc: [
				"角色在演唱，开始♪的歌声之环中时，体力消耗降低12%。"
			],
		},
		{
			name: "安可",
			desc: [
				"当前场上自己的角色获得元素晶球或元素微粒时，延长演唱，开始♪歌声之环持续时间1秒。",
				"通过这种方式，至多延长5秒。"
			],
		}
	],
	attr: {
		...
		details: new Map([
			["1", [821, 13.36, 56.08, 0]],
			["20", [2108, 34.31, 144.07, 0]],
			["40", [4076, 66.34, 278.55, 0]],
			["50", [5189, 84.46, 354.64, 6]],
			["60", [6448, 104.95, 440.66, 12]],
			["70", [7561, 123.05, 516.69, 12]],
			["80", [8674, 141.18, 592.78, 18]],
			["90", [9787, 159.3, 668.87, 24]],
			["20+", [2721, 44.29, 185.97, 0]],
			["40+", [4512, 73.43, 308.32, 6]],
			["50+", [5770, 93.91, 394.33, 12]],
			["60+", [6884, 112.04, 470.42, 12]],
			["70+", [7996, 130.14, 546.46, 18]],
			["80+", [9110, 148.27, 622.55, 24]]
		])
	},
};