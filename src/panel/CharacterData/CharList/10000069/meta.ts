...
export const meta: CharDetailInfo  = {
	...
	materials:{
		...
		[MaterialType.boss]: "蕈王钩喙",
		[MaterialType.specialty]: "月莲",
	...
	cons: new Map([
		...
		[2, {
			name: "由茎干剖析来缘",
			desc: [
				"当识果种雷的识蕴领域中存在敌人时，提纳里获得20%草元素伤害加成。",
		...
		[4, {
			name: "由片叶管窥枯荣",
			desc: [
				"施放造生缠藤箭时，队伍中附近的所有角色的元素精通提升60点，持续8秒。若造生缠藤箭触发了燃烧、绽放、原激化或蔓激化反应，元素精通将进一步提升60点，并刷新该状态的持续时间。"
			]
		}],
		[5, {
			name: "由繁花明了悟觉",
	...
	attr:{
		...
		details: new Map([
			["1", [845, 20.85, 49.06, 0]],
			["20", [2191, 54.1, 127.26, 0]],
			["40", [4362, 107.7, 253.37, 0]],
			["50", [5611, 138.53, 325.89, 7.2]],
			["60", [7038, 173.77, 408.82, 14.4]],
			["70", [8301, 204.96, 482.18, 14.4]],
			["80", [9573, 236.34, 556.02, 21.6]],
			["90", [10850, 267.88, 630.21, 28.8]],
			["20+", [2915, 71.98, 169.33, 0]],
			["40+", [4877, 120.4, 283.26, 7.2]],
			["50+", [6297, 155.46, 365.74, 14.4]],
			["60+", [7553, 186.48, 438.71, 14.4]],
			["70+", [8816, 217.66, 512.07, 21.6]],
			["80+", [10087, 249.05, 585.91, 28.8]]
		])
	},
};