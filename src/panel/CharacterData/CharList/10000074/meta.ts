...
export const meta: CharDetailInfo  = {
	...
	cons: new Map([
		[1, {
			name: "寐领围垣",
			desc: [
				"垂裳端凝之夜的安眠帷幕护盾的伤害吸收量提高20%。",
				"此外，施放垂裳端凝之夜时，将为队伍中附近不处于安眠帷幕护盾庇护下的所有角色生成伤害吸收量为安眠帷幕护盾35%的护盾，该护盾持续12秒，对冰元素伤害有250%的吸收效果。"
			]
		}],
		[2, {
			name: "归芒携信",
		...
		[6, {
			name: "曜光灵炬",
			desc: [
				"垂裳端凝之夜的飞星造成的伤害提升40%，星流摇床之梦的星光弹造成的伤害提升40%。",
	...
	attr:{
		...
		details: new Map([
			["1", [930, 18.16, 54.94, 0]],
			["20", [2389, 46.66, 141.13, 0]],
			["40", [4619, 90.22, 272.87, 0]],
			["50", [5881, 114.87, 347.41, 6]],
			["60", [7308, 142.73, 431.66, 12]],
			["70", [8569, 167.35, 506.15, 12]],
			["80", [9831, 192, 580.68, 18]],
			["90", [11092, 216.65, 655.22, 24]],
			["20+", [3084, 60.23, 182.17, 0]],
			["40+", [5113, 99.86, 302.03, 6]],
			["50+", [6540, 127.72, 386.29, 12]],
			["60+", [7801, 152.37, 460.82, 12]],
			["70+", [9062, 177, 535.31, 18]],
			["80+", [10324, 201.64, 609.84, 24]]
		])
	},
};