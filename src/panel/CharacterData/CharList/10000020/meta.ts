...
export const metaData = {
	...
	cons: new Map([
		...
		[6, {
			name: "天狼",
			desc: [
				"每10秒，雷泽的大剑将自动充能，使下一次普通攻击引发落雷，造成100%攻击力的雷元素伤害。",
	...
	attr: {
		...
		details: new Map([
			...
			["50", [6343, 123.88, 398.07, 7.5]],
			["60", [7881, 153.92, 494.62, 15]],
			["70", [9241, 180.48, 579.96, 15]],
			["80", [10602, 207.06, 665.37, 22.5]],
			["90", [11962, 233.64, 750.77, 30]],
			["20+", [3326, 64.96, 208.74, 0]],
			["40+", [5514, 107.7, 346.08, 7.5]],
			["50+", [7052, 137.74, 442.62, 15]],
			["60+", [8413, 164.32, 528.03, 15]],
			["70+", [9773, 190.88, 613.37, 22.5]],
			["80+", [11134, 217.46, 698.78, 30]]
		])
	},
};