...
export const meta: CharDetailInfo  = {
	...
	passive: [
		...
		},
		{
			name: "延命妙法",
			desc: [
				"处于仙法·寒病鬼差状态下的角色触发元素反应时，受治疗加成提升20%，持续8秒。"
			],
		},
		{
			name: "玉签偶开",
	...
	attr:{
		...
		details: new Map([
			["1", [963, 22.34, 71.8, 0]],
			["20", [2498, 57.96, 186.24, 0]],
			["40", [4973, 115.39, 370.79, 0]],
			["50", [6396, 148.42, 476.92, 5.54]],
			["60", [8023, 186.19, 598.27, 11.08]],
			["70", [9463, 219.59, 705.62, 11.08]],
			["80", [10912, 253.23, 813.69, 16.62]],
			["90", [12368, 287.01, 922.27, 22.15]],
			["20+", [3323, 77.12, 247.8, 0]],
			["40+", [5559, 129, 414.53, 5.54]],
			["50+", [7178, 166.57, 535.24, 11.08]],
			["60+", [8610, 199.8, 642.01, 11.08]],
			["70+", [10050, 233.21, 749.36, 16.62]],
			["80+", [11499, 266.84, 857.43, 22.15]]
		])
	},
};