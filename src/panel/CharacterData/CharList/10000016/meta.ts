...
export const meta: CharDetailInfo  = {
	...
	cons: new Map([
		...
		[6, {
			name: "清算黑暗的炎之剑",
			desc: [
				"施放逆焰之刃后，接下来6秒内的2次普通攻击速度提升30%，造成的伤害提高30%。",
				"此外，逆焰之刃不再重置普通攻击连击段数。"
			]
		}]
	]),
	...
	attr:{
		...
		details: new Map([
			["1", [1011, 26.07, 61.03, 0]],
			["20", [2621, 67.62, 158.3, 0]],
			["40", [5219, 134.62, 315.17, 0]],
			["50", [6713, 173.16, 405.38, 4.8]],
			["60", [8421, 217.22, 508.53, 9.6]],
			["70", [9932, 256.19, 599.78, 9.6]],
			["80", [11453, 295.43, 691.64, 14.4]],
			["90", [12981, 334.85, 783.93, 19.2]],
			["20+", [3488, 89.97, 210.63, 0]],
			["40+", [5834, 150.5, 352.35, 4.8]],
			["50+", [7533, 194.33, 454.95, 9.6]],
			["60+", [9036, 233.1, 545.71, 9.6]],
			["70+", [10547, 272.07, 636.96, 14.4]],
			["80+", [12068, 311.31, 728.82, 19.2]]
		])
	},
};