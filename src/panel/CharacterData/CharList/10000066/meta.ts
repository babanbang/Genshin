...
export const meta: CharDetailInfo  = {
	...
	cons: new Map([
		...
		[2, {
			name: "世有源泉",
			desc: [
				"浪闪叠加上限提升至5层；神里绫人处于至少3层浪闪状态下时，将提升50%生命值上限。"
			]
		}],
		[3, {
			name: "无意弄花",
		...
		[6, {
			name: "滥觞无底",
			desc: [
				"施放神里流·镜花之后，神里绫人的下一次瞬水剑攻击命中敌人时，将进行2次额外的瞬水剑攻击，各自能造成神里绫人攻击力450%的伤害。",
				"此两次瞬水剑攻击不会受到浪闪的增益。"
			]
		}]
	]),
	...
	attr:{
		...
		details: new Map([
			["1", [1068, 23.27, 59.83, 0]],
			["20", [2770, 60.38, 155.2, 0]],
			["40", [5514, 120.2, 308.99, 0]],
			["50", [7092, 154.6, 397.43, 9.6]],
			["60", [8897, 193.94, 498.56, 19.2]],
			["70", [10494, 228.74, 588.02, 19.2]],
			["80", [12101, 263.78, 678.08, 28.8]],
			["90", [13715, 298.97, 768.55, 38.4]],
			["20+", [3685, 80.33, 206.5, 0]],
			["40+", [6165, 134.38, 345.44, 9.6]],
			["50+", [7960, 173.51, 446.03, 19.2]],
			["60+", [9548, 208.12, 535.01, 19.2]],
			["70+", [11144, 242.92, 624.47, 28.8]],
			["80+", [12751, 277.96, 714.53, 38.4]]
		])
	},
};