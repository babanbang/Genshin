...
export const meta: CharDetailInfo  = {
	...
	cons: new Map([
		...
		[4, {
			name: "韦驮骏足",
			desc: [
				"处于安全运输护盾或安全运输护盾·要件的当前场上角色的普通攻击、重击与下落攻击命中敌人后，绮良良将使用猫草小豆蔻进行协同攻击，造成相当于绮良良攻击力200%草元素伤害，通过这种方式造成的伤害视为元素爆发伤害。此效果每3.8秒至多触发一次，队伍中所有角色共享冷却时间。"
			]
		}],
		[5, {
			name: "千里一日",
	...
	passive: [
		...
		},
		{
			name: "妖说歧尾之变",
			desc: [
				"绮良良处于呜喵町飞足的猫箱急件状态下时，每次冲撞触及敌人，都将获得一层加固包装，此效果每0.5秒对每个敌人至多触发一次，至多叠加3层。猫箱急件状态结束时，每层加固包装都将为绮良良生成一个安全运输护盾，通过这种方式生成的护盾的伤害吸收量相当于呜喵町飞足生成的安全运输护盾的20%，若绮良良已处于呜喵町飞足的安全运输护盾的庇护下，剩余的伤害吸收量将叠加，并刷新持续时间。"
			],
		},
		{
			name: "应时惑目之灵",
	...
	attr:{
		...
		details: new Map([
			["1", [1021, 18.7, 45.78, 0]],
			["20", [2623, 48.04, 117.61, 0]],
			["40", [5072, 92.88, 227.39, 0]],
			["50", [6458, 118.25, 289.51, 6]],
			["60", [8024, 146.93, 359.72, 12]],
			["70", [9409, 172.28, 421.79, 12]],
			["80", [10794, 197.65, 483.9, 18]],
			["90", [12180, 223.02, 546.02, 24]],
			["20+", [3386, 62.01, 151.81, 0]],
			["40+", [5614, 102.8, 251.69, 6]],
			["50+", [7181, 131.48, 321.91, 12]],
			["60+", [8566, 156.85, 384.02, 12]],
			["70+", [9951, 182.2, 446.09, 18]],
			["80+", [11336, 207.57, 508.2, 24]]
		])
	},
};