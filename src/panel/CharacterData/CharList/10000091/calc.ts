details = [{
  ...
  title: '0消耗典仪式晶火',
    dmg: ({ talent }, { dmg }) => dmg(talent[GsTalentType.e].get('玫瑰晶弹基础伤害'], GsTalentType.e)
}, {
  title: '3消耗典仪式晶火',
    params: { jp: 3 },
  dmg: ({ talent }, { dmg }) => dmg(talent[GsTalentType.e].get('玫瑰晶弹基础伤害'] * 2, GsTalentType.e)
}, {
  title: '6消耗典仪式晶火',
    params: { jp: 6 },
  dmg: ({ talent }, { dmg }) => dmg(talent[GsTalentType.e].get('玫瑰晶弹基础伤害'] * 2, GsTalentType.e)
  ...
  title: '支援炮击伤害',
    dmg: ({ talent }, { dmg }) => dmg(talent[GsTalentType.q].get('支援炮击伤害'], GsTalentType.q)
}, {
  title: '结晶护盾吸收量',
