...
export const meta: CharDetailInfo  = {
	...
	cons: new Map([
		...
		[2, {
			name: "诸般切末",
			desc: [
				"施放破嶂见旌仪后，附近队伍中所有角色普通攻击造成的伤害提升15%，持续12秒。"
			]
		}],
		[3, {
			name: "牙纛探海",
	...
	attr:{
		...
		details: new Map([
			["1", [894, 16.03, 61.57, 0]],
			["20", [2296, 41.17, 158.18, 0]],
			["40", [4438, 79.61, 305.84, 0]],
			["50", [5651, 101.35, 389.39, 6.67]],
			["60", [7021, 125.94, 483.82, 13.33]],
			["70", [8233, 147.67, 567.31, 13.33]],
			["80", [9445, 169.41, 650.85, 20]],
			["90", [10657, 191.16, 734.39, 26.67]],
			["20+", [2963, 53.15, 204.18, 0]],
			["40+", [4913, 88.12, 338.53, 6.67]],
			["50+", [6283, 112.7, 432.96, 13.33]],
			["60+", [7495, 134.44, 516.51, 13.33]],
			["70+", [8707, 156.17, 599.99, 20]],
			["80+", [9919, 177.92, 683.53, 26.67]]
		])
	},
};