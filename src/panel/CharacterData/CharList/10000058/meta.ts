...
export const meta: CharDetailInfo  = {
	...
	passive: [
		...
		},
		{
			name: "神篱之御荫",
			desc: [
				"施放大密法·天狐显真时，每摧毁一株杀生樱，就会重置一次野干役咒·杀生樱的冷却时间。"
			],
		},
		{
			name: "启蜇之祝词",
			desc: [
				"八重神子的每点元素精通，能使杀生樱造成的伤害提升0.15%。"
			],
		}
	],
	attr:{
		...
		details: new Map([
			["1", [807, 26.44, 44.27, 0]],
			["20", [2095, 68.59, 114.85, 0]],
			["40", [4170, 136.55, 228.65, 0]],
			["50", [5364, 175.63, 294.1, 4.8]],
			["60", [6729, 220.32, 368.94, 9.6]],
			["70", [7936, 259.85, 435.13, 9.6]],
			["80", [9151, 299.65, 501.78, 14.4]],
			["90", [10372, 339.63, 568.73, 19.2]],
			["20+", [2787, 91.25, 152.81, 0]],
			["40+", [4662, 152.65, 255.62, 4.8]],
			["50+", [6020, 197.11, 330.06, 9.6]],
			["60+", [7220, 236.43, 395.91, 9.6]],
			["70+", [8428, 275.96, 462.11, 14.4]],
			["80+", [9643, 315.76, 528.75, 19.2]]
		])
	},
};