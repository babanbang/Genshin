...
export const metaData = {
	...
	cons: new Map([
		...
		[2, {
			name: "纠集众人，斗倒御岳",
			desc: [
				"施放最恶鬼王·一斗轰临！！后，队伍中每个元素类型为岩元素的角色，都将使其冷却时间减少1.5秒，使荒泷一斗的元素能量恢复6点。",
	...
	attr: {
		...
		details: new Map([
			["1", [1001, 17.69, 74.67, 0]],
			["20", [2597, 45.89, 193.69, 0]],
			["40", [5170, 91.35, 385.62, 0]],
			["50", [6649, 117.5, 495.99, 4.8]],
			["60", [8341, 147.4, 622.2, 9.6]],
			["70", [9838, 173.85, 733.85, 9.6]],
			["80", [11345, 200.47, 846.24, 14.4]],
			["90", [12858, 227.22, 959.16, 19.2]],
			["20+", [3455, 61.05, 257.71, 0]],
			["40+", [5779, 102.13, 431.11, 4.8]],
			["50+", [7462, 131.87, 556.65, 9.6]],
			["60+", [8951, 158.17, 667.69, 9.6]],
			["70+", [10448, 184.62, 779.34, 14.4]],
			["80+", [11954, 211.25, 891.73, 19.2]]
		])
	},
};