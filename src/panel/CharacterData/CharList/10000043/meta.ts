...
export const meta: CharDetailInfo  = {
	...
	cons: new Map([
		...
		[4, {
			name: "炼金的偏执",
			desc: [
				"砂糖的普通攻击或者重击累计命中敌人7次，风灵作成·陆叁零捌的冷却时间就会随机减少1-7秒。",
				"每0.1秒至多计数一次。"
			]
		}],
		[5, {
	...
	attr:{
		...
		details: new Map([
			["1", [775, 14.25, 58.94, 0]],
			["20", [1991, 36.6, 151.42, 0]],
			["40", [3850, 70.76, 292.77, 0]],
			["50", [4901, 90.09, 372.74, 6]],
			["60", [6090, 111.94, 463.14, 12]],
			["70", [7141, 131.26, 543.05, 12]],
			["80", [8192, 150.59, 623.03, 18]],
			["90", [9244, 169.92, 703, 24]],
			["20+", [2570, 47.24, 195.45, 0]],
			["40+", [4261, 78.33, 324.05, 6]],
			["50+", [5450, 100.18, 414.45, 12]],
			["60+", [6501, 119.51, 494.43, 12]],
			["70+", [7552, 138.82, 574.34, 18]],
			["80+", [8604, 158.15, 654.31, 24]]
		])
	},
};