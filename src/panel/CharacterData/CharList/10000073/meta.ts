...
export const meta: CharDetailInfo  = {
	...
	cons: new Map([
		...
		[6, {
			name: "大辨圆成之实",
			desc: [
				"施放心景幻成后，纳西妲的普通攻击或重击命中处于所闻遍计的蕴种印状态下的敌人时，将对该敌人及其所处连结中的所有敌人释放灭净三业·业障除，基于纳西妲攻击力的200%与元素精通的400%，造成草元素伤害。",
	...
	attr:{
		...
		details: new Map([
			["1", [807, 23.27, 49.06, 0]],
			["20", [2092, 60.38, 127.26, 0]],
			["40", [4165, 120.2, 253.37, 0]],
			["50", [5357, 154.6, 325.89, 28.799999237061]],
			["60", [6721, 193.94, 408.82, 57.599998474121]],
			["70", [7926, 228.74, 482.18, 57.599998474121]],
			["80", [9140, 263.78, 556.02, 86.400001525879]],
			["90", [10360, 298.97, 630.21, 115.19999694824]],
			["20+", [2784, 80.33, 169.33, 0]],
			["40+", [4656, 134.38, 283.26, 28.799999237061]],
			["50+", [6012, 173.51, 365.74, 57.599998474121]],
			["60+", [7212, 208.12, 438.71, 57.599998474121]],
			["70+", [8418, 242.92, 512.07, 86.400001525879]],
			["80+", [9632, 277.96, 585.91, 115.19999694824]]
		])
	},
};