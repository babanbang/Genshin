...
export const metaData = {
	...
	cons: new Map([
		[1, {
			name: "饮露",
			desc: [
				"二段蓄力重击的霜华矢或霜华绽发命中敌人时，会使敌人的冰元素抗性降低15%，持续6秒；",
		...
		[4, {
			name: "西狩",
			desc: [
				"在降众天华的领域内，敌人受到的伤害会增加，这个效果会随时间逐步加强。",
	...
	attr: {
		...
		details: new Map([
			["1", [763, 26.07, 49.06, 0]],
			["20", [1978, 67.62, 127.26, 0]],
			["40", [3939, 134.62, 253.37, 0]],
			["50", [5066, 173.16, 325.89, 9.6]],
			["60", [6355, 217.22, 408.82, 19.2]],
			["70", [7495, 256.19, 482.18, 19.2]],
			["80", [8643, 295.43, 556.02, 28.8]],
			["90", [9797, 334.85, 630.21, 38.4]],
			["20+", [2632, 89.97, 169.33, 0]],
			["40+", [4403, 150.5, 283.26, 9.6]],
			["50+", [5686, 194.33, 365.74, 19.2]],
			["60+", [6820, 233.1, 438.71, 19.2]],
			["70+", [7960, 272.07, 512.07, 28.8]],
			["80+", [9108, 311.31, 585.91, 38.4]]
		])
	},
};