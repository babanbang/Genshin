...
export const metaData = {
	...
	passive: [
		...
		},
		{
			name: "绪风之拥",
			desc: [
				"长按高天之歌后，会产生上升气流，持续20秒。"
			],
		},
		{
			name: "暴风之眼",
			desc: [
				"风神之诗效果结束后，会为温迪恢复15点元素能量；",
	...
	attr: {
		...
		details: new Map([
			["1", [820, 20.48, 52.05, 0]],
			["20", [2127, 53.13, 135.02, 0]],
			["40", [4234, 105.78, 268.82, 0]],
			["50", [5446, 136.05, 345.76, 8]],
			["60", [6832, 170.67, 433.75, 16]],
			["70", [8058, 201.3, 511.58, 16]],
			["80", [9292, 232.12, 589.93, 24]],
			["90", [10531, 263.1, 668.64, 32]],
			["20+", [2830, 70.69, 179.65, 0]],
			["40+", [4734, 118.25, 300.53, 8]],
			["50+", [6112, 152.69, 388.05, 16]],
			["60+", [7331, 183.15, 465.46, 16]],
			["70+", [8557, 213.77, 543.29, 24]],
			["80+", [9791, 244.6, 621.64, 32]]
		])
	},
};