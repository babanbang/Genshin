...
export const metaData = {
	...
	cons: new Map([
		[1, {
			name: "犬奔·疾如风",
			desc: [
				"处于五郎自己的大将旗指物或大将威仪领域中的当前场上角色（除了五郎自己）对敌人造成岩元素伤害后，五郎自己的犬坂吠吠方圆阵冷却时间减少2秒。",
				"该效果每10秒至多触发一次。"
			]
		}],
		[2, {
			name: "犬坐·稳如钟",
			desc: [
				"在大将威仪的持续期间，附近的当前场上角色获取结晶反应产生的晶片后，五郎自己的大将威仪的持续时间延长1秒。",
	...
	passive: [
		...
		},
		{
			name: "不畏风雨",
			desc: [
				"施放兽牙逐突形胜战法后的12秒内，附近的队伍中所有角色的防御力提升25%。"
			],
		},
		{
			name: "报恩之守",
	...
	attr: {
		...
		details: new Map([
			["1", [802, 15.31, 54.36, 0]],
			["20", [2061, 39.34, 139.66, 0]],
			["40", [3985, 76.07, 270.03, 0]],
			["50", [5074, 96.85, 343.79, 6]],
			["60", [6305, 120.34, 427.17, 12]],
			["70", [7393, 141.1, 500.87, 12]],
			["80", [8481, 161.88, 574.63, 18]],
			["90", [9570, 182.66, 648.4, 24]],
			["20+", [2661, 50.79, 180.27, 0]],
			["40+", [4411, 84.2, 298.88, 6]],
			["50+", [5642, 107.69, 382.26, 12]],
			["60+", [6731, 128.47, 456.02, 12]],
			["70+", [7819, 149.23, 529.73, 18]],
			["80+", [8907, 170.01, 603.49, 24]]
		])
	},
};