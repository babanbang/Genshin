...
export const meta: CharDetailInfo  = {
	...
	cons: new Map([
		...
		[4, {
			name: "骞林馈遗",
			desc: [
				"施放猫猫秘宝时，将使队伍中附近的所有角色（不包括柯莱自己）的元素精通提升60点，持续12秒。"
			]
		}],
		[5, {
			name: "俱象残火",
		...
		[6, {
			name: "坠镞为林",
			desc: [
				"飞叶轮命中时，会产生一个迷你柯里安巴，造成相当于柯莱攻击力200%的草元素伤害。",
	...
	attr:{
		...
		details: new Map([
			["1", [821, 16.74, 50.36, 0]],
			["20", [2108, 43, 129.37, 0]],
			["40", [4076, 83.15, 250.13, 0]],
			["50", [5189, 105.86, 318.46, 6]],
			["60", [6448, 131.53, 395.69, 12]],
			["70", [7561, 154.23, 463.97, 12]],
			["80", [8674, 176.94, 532.29, 18]],
			["90", [9787, 199.65, 600.62, 24]],
			["20+", [2721, 55.51, 166.99, 0]],
			["40+", [4512, 92.03, 276.86, 6]],
			["50+", [5770, 117.71, 354.1, 12]],
			["60+", [6884, 140.42, 422.42, 12]],
			["70+", [7996, 163.11, 490.7, 18]],
			["80+", [9110, 185.83, 559.02, 24]]
		])
	},
};