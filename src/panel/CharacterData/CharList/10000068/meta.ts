...
export const metaData = {
	...
	passive: [
		{
			name: "意外订单",
			desc: [
				"合成角色与武器培养素材时，有25%的概率返还部分合成材料。"
			],
		},
		{
			name: "披沙沥金",
			desc: [
				"与灯中幽精相连的角色在触发感电、超导、超载、原激化、超激化、超绽放、雷元素扩散或雷元素结晶反应后，镇灵之灯·烦恼解决炮的冷却时间缩短1秒。",
				"该效果每3秒至多触发一次。"
			],
		},
		{
			name: "利上加利",
			desc: [
				"镇灵之灯·烦恼解决炮的断除烦恼炮或售后服务弹命中敌人时，基于多莉的元素充能效率，每100%为多莉恢复5点元素能量。",
	...
	attr: {
		...
		details: new Map([
			["1", [1039, 18.7, 60.66, 0]],
			["20", [2670, 48.04, 155.83, 0]],
			["40", [5163, 92.88, 301.29, 0]],
			["50", [6573, 118.25, 383.6, 6]],
			["60", [8168, 146.93, 476.63, 12]],
			["70", [9577, 172.28, 558.87, 12]],
			["80", [10987, 197.65, 641.17, 18]],
			["90", [12397, 223.02, 723.47, 24]],
			["20+", [3447, 62.01, 201.15, 0]],
			["40+", [5715, 102.8, 333.49, 6]],
			["50+", [7309, 131.48, 426.53, 12]],
			["60+", [8719, 156.85, 508.83, 12]],
			["70+", [10129, 182.2, 591.07, 18]],
			["80+", [11539, 207.57, 673.37, 24]]
		])
	},
};