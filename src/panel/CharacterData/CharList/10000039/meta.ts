...
export const metaData = {
	...
	passive: [
		...
		},
		{
			name: "猫尾隐藏菜单",
			desc: [
				"处于猫爪冻冻的护盾保护下的角色，移动速度提升10%，体力消耗降低10%。"
			],
		},
		{
			name: "滑稽百出的醉相",
			desc: [
				"敌人进入最烈特调的领域后的15秒内，攻击力降低10%。"
			],
		}
	],
	attr: {
		...
		details: new Map([
			["1", [802, 17.81, 50.36, 0]],
			["20", [2061, 45.75, 129.37, 0]],
			["40", [3985, 88.45, 250.13, 0]],
			["50", [5074, 112.62, 318.46, 6]],
			["60", [6305, 139.93, 395.69, 12]],
			["70", [7393, 164.07, 463.97, 12]],
			["80", [8481, 188.24, 532.29, 18]],
			["90", [9570, 212.4, 600.62, 24]],
			["20+", [2661, 59.05, 166.99, 0]],
			["40+", [4411, 97.91, 276.86, 6]],
			["50+", [5642, 125.22, 354.1, 12]],
			["60+", [6731, 149.38, 422.42, 12]],
			["70+", [7819, 173.53, 490.7, 18]],
			["80+", [8907, 197.69, 559.02, 24]]
		])
	},
};