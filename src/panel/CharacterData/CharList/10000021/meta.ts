...
export const metaData = {
	...
	cons: new Map([
		...
		[2, {
			name: "一触即发",
			desc: [
				"兔兔伯爵进行了全新改良！蓄力完成的瞄准射击命中兔兔伯爵脚部时，能直接引爆兔兔伯爵…",
	...
	attr: {
		...
		details: new Map([
			["1", [793, 18.7, 50.36, 0]],
			["20", [2038, 48.04, 129.37, 0]],
			["40", [3940, 92.88, 250.13, 0]],
			["50", [5016, 118.25, 318.46, 6]],
			["60", [6233, 146.93, 395.69, 12]],
			["70", [7309, 172.28, 463.97, 12]],
			["80", [8385, 197.65, 532.29, 18]],
			["90", [9461, 223.02, 600.62, 24]],
			["20+", [2630, 62.01, 166.99, 0]],
			["40+", [4361, 102.8, 276.86, 6]],
			["50+", [5578, 131.48, 354.1, 12]],
			["60+", [6654, 156.85, 422.42, 12]],
			["70+", [7730, 182.2, 490.7, 18]],
			["80+", [8806, 207.57, 559.02, 24]]
		])
	},
};