...
export const meta: CharDetailInfo  = {
	...
	cons: new Map([
		...
		[2, {
			name: "入彀者，多多益善",
			desc: [
				"「玄掷玲珑」协同攻击时，会发射一枚额外的水箭，造成相当于夜兰生命值上限14%的水元素伤害。",
				"该效果每1.8秒至多触发一次。"
			]
		}],
		[3, {
	...
	attr:{
		...
		details: new Map([
			["1", [1125, 18.99, 42.66, 0]],
			["20", [2918, 49.27, 110.66, 0]],
			["40", [5810, 98.08, 220.31, 0]],
			["50", [7472, 126.16, 283.37, 4.8]],
			["60", [9374, 158.26, 355.47, 9.6]],
			["70", [11056, 186.66, 419.26, 9.6]],
			["80", [12749, 215.24, 483.47, 14.4]],
			["90", [14450, 243.96, 547.98, 19.2]],
			["20+", [3883, 65.55, 147.23, 0]],
			["40+", [6495, 109.65, 246.3, 4.8]],
			["50+", [8386, 141.58, 318.02, 9.6]],
			["60+", [10059, 169.83, 381.46, 9.6]],
			["70+", [11741, 198.23, 445.25, 14.4]],
			["80+", [13434, 226.81, 509.46, 19.2]]
		])
	},
};