...
export const meta: CharDetailInfo  = {
	...
	passive: [
		...
		},
		{
			name: "炎昼风物诗",
			desc: [
				"施放琉金云间草后的15秒内，附近的队伍中所有其他角色（不包括宵宫自己）攻击力提高10%。此外，依据宵宫自己施放琉金云间草时固有天赋「袖火百景图」的叠加层数，将额外提升上述的攻击力效果，每层提升1%攻击力。"
			],
		}
	],
	attr:{
		...
		details: new Map([
			["1", [791, 25.14, 47.86, 0]],
			["20", [2053, 65.21, 124.16, 0]],
			["40", [4086, 129.82, 247.19, 0]],
			["50", [5256, 166.97, 317.94, 4.8]],
			["60", [6593, 209.46, 398.85, 9.6]],
			["70", [7777, 247.04, 470.42, 9.6]],
			["80", [8968, 284.88, 542.46, 14.4]],
			["90", [10164, 322.89, 614.84, 19.2]],
			["20+", [2731, 86.76, 165.2, 0]],
			["40+", [4568, 145.13, 276.35, 4.8]],
			["50+", [5899, 187.39, 356.82, 9.6]],
			["60+", [7076, 224.77, 428.01, 9.6]],
			["70+", [8259, 262.36, 499.58, 14.4]],
			["80+", [9450, 300.19, 571.62, 19.2]]
		])
	},
};