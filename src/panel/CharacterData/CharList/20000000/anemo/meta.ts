...
export const meta: CharDetailInfo = {
	...
	talent: {
		...
		[GsTalentType.q]: {
			...
			name: "风息激荡",
			desc: [
				"导引风行进的路途，唤出持续前进的龙卷风，将沿途的物体与敌人卷入，持续造成风元素伤害。",
				"<h3>元素转化</h3>",
	...
	talentElem: new Map([
		[10067, GsElement.anemo],
		[10068, GsElement.anemo]
	]),
	talentData: {
