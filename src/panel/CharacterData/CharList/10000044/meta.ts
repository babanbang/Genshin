...
export const metaData = {
	...
	cons: new Map([
		...
		[2, {
			name: "开场即兴段",
			desc: [
				"叛逆刮弦造成的物理伤害暴击率提升100%，并会在施放时形成三级护盾·舞遍节拍。"
			]
		}],
		[3, {
			name: "摭分的指法",
	...
	attr: {
		...
		details: new Map([
			["1", [939, 20.84, 66.95, 0]],
			["20", [2413, 53.53, 172, 0]],
			["40", [4665, 103.49, 332.56, 0]],
			["50", [5939, 131.76, 423.4, 6]],
			["60", [7379, 163.72, 526.09, 12]],
			["70", [8653, 191.97, 616.87, 12]],
			["80", [9927, 220.24, 707.71, 18]],
			["90", [11201, 248.5, 798.55, 24]],
			["20+", [3114, 69.09, 222.02, 0]],
			["40+", [5163, 114.55, 368.1, 6]],
			["50+", [6604, 146.51, 470.79, 12]],
			["60+", [7878, 174.78, 561.63, 12]],
			["70+", [9151, 203.03, 652.4, 18]],
			["80+", [10425, 231.29, 743.25, 24]]
		])
	},
};