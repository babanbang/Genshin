...
export const metaData = {
	...
	cons: new Map([
		[1, {
			name: "冒险憧憬",
			desc: [
				"美妙旅程的攻击力提升效果不再有生命值限制，数值上追加班尼特基础攻击力的20%。"
			]
		}],
		[2, {
			name: "踏破绝境",
		...
		[4, {
			name: "热情不灭",
			desc: [
				"施放一段蓄力的热情过载时，在技能第二段攻击中进行普通攻击，可以施放额外的追击。",
				"追击的伤害等同于第二段攻击的135%。"
			]
		}],
		[5, {
	...
	attr: {
		...
		details: new Map([
			["1", [1039, 16.03, 64.66, 0]],
			["20", [2670, 41.17, 166.12, 0]],
			["40", [5163, 79.61, 321.19, 0]],
			["50", [6573, 101.35, 408.93, 6.67]],
			["60", [8168, 125.94, 508.1, 13.33]],
			["70", [9577, 147.67, 595.78, 13.33]],
			["80", [10987, 169.41, 683.51, 20]],
			["90", [12397, 191.16, 771.25, 26.67]],
			["20+", [3447, 53.15, 214.43, 0]],
			["40+", [5715, 88.12, 355.51, 6.67]],
			["50+", [7309, 112.7, 454.69, 13.33]],
			["60+", [8719, 134.44, 542.43, 13.33]],
			["70+", [10129, 156.17, 630.1, 20]],
			["80+", [11539, 177.92, 717.84, 26.67]]
		])
	},
};