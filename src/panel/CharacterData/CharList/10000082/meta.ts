	...
	cons: new Map([
		...
		[2, {
			...
			desc: [
				...
				"游丝徵灵·切将在进行至多1次攻击后返回，造成白术攻击力250%的草元素伤害与太素诊要游丝徵灵的20%回复量。",
				"通过这种方式造成的伤害视为元素战技伤害。",
				"每5秒至多触发一次。"
			]
		}],
		...
		[6, {
			name: "真邪合离",
			desc: [
				"愈气全形论的灵气脉造成的伤害提高，提升值相当于白术生命值上限的8%。",
	...
	passive: [
		{
			name: "味草之滋",
			desc: [
				"白术处于队伍中时，与部分采集物交互能够为队伍中自己的当前场上角色恢复生命值，回复量基于白术生命值上限的2.5%。"
			],
		},
		{
			name: "五运终天",
			desc: [
				...
				"·生命值高于或等于50%时，白术获得25%草元素伤害加成。"
			],
		},
		{
			name: "在地为化",
			desc: [
				"受到无郤气护盾治疗的角色，将获得「木运之岁」效果：基于白术生命值上限不超过50000点的部分，每1000点将使该角色触发的燃烧、绽放、超绽放、烈绽放反应造成的伤害提升2%，超激化、蔓激化反应带来的伤害提升提高0.8%，持续6秒。"
			],
		}
	],
	attr:{
