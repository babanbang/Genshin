details = [{
  ...
  dmg: ({ attr, calc, talent }, { shield }) =>
    shield(calc(attr.hp) * talent[GsTalentType.e].get('护盾吸收量2'][0] / 100 + talent[GsTalentType.e].get('护盾吸收量2'][1])
}, {
  title: '蓄力E伤害',
    dmg: ({ calc, attr, talent }, { basic }) => basic(calc(attr.hp) * talent[GsTalentType.e].get('蓄力完成伤害']/ 100)
}, {
  title: 'Q提升普攻伤害',
    dmg: ({ attr, calc }) => {
      return {
