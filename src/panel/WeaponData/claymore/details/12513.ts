...
export const metaData: WeaponDetailInfo = {
	...
	materials: {
		...
		[MaterialType.monster]: "聚燃的游像眼",
		[MaterialType.normal]: "龙冠武士的金哨"
	},
	affixData: {
		title: "绿松石之狩",
		desc: "元素战技命中敌人后，会获得1层「悬木祝赐」，该效果每0.5秒至多触发1次；队伍中附近的角色触发了燃烧或烈绽放反应后，装备者会获得3层悬木祝赐，该效果每2秒至多触发1次，队伍中的角色处于队伍后台时也能触发。悬木祝赐：元素战技伤害和元素爆发伤害提升$[0]，持续6秒，至多叠加6层，每层持续时间独立计算。",
		datas: {
			"0": [
				"10%",
				"12.5%",
