...
export const metaData = {
	...
	cons: new Map([
		[1, {
			name: "连环轰隆",
			desc: [
				"攻击与施放技能时，有几率召唤火花轰击敌人，造成相当于轰轰火花攻击伤害120%的伤害。"
			]
		}],
		[2, {
			name: "破破弹片",
			desc: [
				"蹦蹦炸弹的诡雷会使敌人的防御力降低23%，持续10秒。"
			]
		}],
		[3, {
			name: "可莉特调",
		...
		[6, {
			name: "火力全开",
			desc: [
				"在轰轰火花的状态下，可莉每3秒会为队伍中所有角色（不包括可莉自己）恢复3点元素能量；",
	...
	passive: [
		...
		},
		{
			name: "砰砰礼物",
			desc: [
				"蹦蹦炸弹与普通攻击造成伤害时，有50%的几率赋予可莉一朵爆裂火花。",
	...
	attr: {
		...
		details: new Map([
			["1", [801, 24.21, 47.86, 0]],
			["20", [2077, 62.79, 124.16, 0]],
			["40", [4136, 125.01, 247.19, 0]],
			["50", [5319, 160.79, 317.94, 7.2]],
			["60", [6673, 201.7, 398.85, 14.4]],
			["70", [7870, 237.89, 470.42, 14.4]],
			["80", [9076, 274.33, 542.46, 21.6]],
			["90", [10287, 310.93, 614.84, 28.8]],
			["20+", [2764, 83.54, 165.2, 0]],
			["40+", [4623, 139.75, 276.35, 7.2]],
			["50+", [5970, 180.45, 356.82, 14.4]],
			["60+", [7161, 216.45, 428.01, 14.4]],
			["70+", [8358, 252.64, 499.58, 21.6]],
			["80+", [9563, 289.07, 571.62, 28.8]]
		])
	},
};